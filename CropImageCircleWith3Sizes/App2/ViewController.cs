...
namespace App2
{
    public partial class ViewController : UIViewController
    {
        ...
        public override void PrepareForSegue(UIStoryboardSegue segue, NSObject sender)
        {
            ...
            if (segue.Identifier.Equals("btnShowCropSegue"))
            {
                var cropCGImage = _imageView.Image.CGImage.WithImageInRect(cropperView.CropRect);

                var reusltView = segue.DestinationViewController as ViewControllerResult;
                reusltView.ImageResult = UIImage.FromImage(cropCGImage);
